...
var ListProviderMonthAvailabilityService = /** @class */ (function () {
    ...
    ListProviderMonthAvailabilityService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var AppointmentsbyMonth, numberOfDaysInMonth, eachDayArray, availability;
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        availability = eachDayArray.map(function (day) {
                            ...
                            var appointmentsByDay = AppointmentsbyMonth.filter(function (appointment) {
                                return date_fns_1.getDate(appointment.date) === day;
                            });
                            return {
                                day: day,
                                available: date_fns_1.isAfter(compareDate, new Date()) && appointmentsByDay.length < 10,
                            };
                        });
