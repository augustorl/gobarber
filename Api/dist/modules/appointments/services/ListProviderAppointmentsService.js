    ...
    ListProviderAppointmentsService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.cacheProvider.recover("provider-appointments:" + provider_id + ":" + day + "-" + month + "-" + year)];
                    case 1:
                    ...
                    case 2:
                        appointments = _b.sent();
                        return [4 /*yield*/, this.cacheProvider.save({
                                key: "provider-appointments:" + provider_id + ":" + day + "-" + month + "-" + year,
                                value: class_transformer_1.classToClass(appointments),
                            })];
                    case 3:
                        _b.sent();
                        _b.label = 4;
