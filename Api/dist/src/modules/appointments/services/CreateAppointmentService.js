...
var CreateAppointmentService = /** @class */ (function () {
    function CreateAppointmentService(appointmentsRepository, cacheProvider, notificationsRepository) {
    ...
    CreateAppointmentService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var appointmentDate, hour, findAppointmentInSameDate, appointment, formattedDate;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        appointmentDate = date_fns_1.startOfHour(date);
                        if (date_fns_1.isBefore(appointmentDate, Date.now())) {
                            throw new AppError_1.default('You cannot create an appointment on a past date');
                        }
                        if (user_id === provider_id) {
                            throw new AppError_1.default('You cannot create an appointment with yourself');
                        }
                        hour = date_fns_1.getHours(appointmentDate);
                        if (hour < 8 || hour > 17) {
                    ...
                    case 2:
                        appointment = _b.sent();
                        formattedDate = date_fns_1.format(appointmentDate, "dd/MM/yyyy 'às' HH:mm");
